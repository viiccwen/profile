/** Experience, education, honors, open source, community copy (en) */
export const experience = {
  ...
  "Extended Mahout's QDP Python and Rust APIs to support float32 GPU pipelines.":
    "Extended Mahout's QDP Python and Rust APIs to support float32 GPU pipelines.",
  "Contributed 30+ PRs focusing on designing & optimizing QDP performance.":
    "Contributed 30+ PRs focusing on designing & optimizing QDP performance.",
  "Helped review 60+ PRs focusing on code quality and performance.":
    "Helped review 60+ PRs focusing on code quality and performance.",
  ...
  "applied these learnings at work, achieving 10x storage savings (400GB → 40GB) by optimizing schema design and leveraging ClickHouse's compression and engine capabilities.":
    "applied these learnings at work, achieving 10x storage savings (400GB → 40GB) by optimizing schema design and leveraging ClickHouse's compression and engine capabilities.",
  "NTU AI Club": "NTU AI Club",
  "NTU FinTech Club": "NTU FinTech Club",
  "GDG on Campus NTUST": "GDG on Campus NTUST",
} as const;
